...
print rown
##
dataInit = pp.scale(dataInit) # standardizing data
...
optim=tf.train.GradientDescentOptimizer(2.5e-4,name="GradientDescent")# use gradient descent in the trainig phase
...
for i in range(N_its):
    ...
    if i==N_its-1:
        ...
        print "Training error: %f" % cost.eval(feed_dict=train_data,session=sess) # for Nits = 20000, train error =  3e-6
                                                                                  # for Nits = 10000, train error = 0.005
                                                                                  # for Nits = 5000, train error = 1.044
# obtaining parameters from training model
...
print "Test error: %f" % costt.eval(feed_dict=test_data, session=sess_test) # for Nits=20000, test error = 274.55
                                                                            # for Nits=10000, test error = 274.44    
                                                                            # for Nits=5000, test error = 273.05
